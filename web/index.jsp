...
<html lang="en">
  ...
  <head>
    ...
    <title>Rent Service - For Your Service</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Nepal</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <h1 class="brand-heading">Rent Service</h1>
              <p class="intro-text">Get the room of your choice</p>
