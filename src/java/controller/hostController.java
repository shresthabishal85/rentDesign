...
public class hostController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(msg.equals("upload"))
        {
            ...
            if (ext.equalsIgnoreCase("jpg") || ext.equalsIgnoreCase("png")) {
                ...
                try {
                    h.fileupload(request,owner,name,filename,location,price);
                } catch (Exception ex) {
    ...
    if(msg.equals("location"))
    {
        ...
        try {
                List<Hostels> list =h.getHostels(location);
                System.out.println(list);
                RequestDispatcher rd = request.getRequestDispatcher("listofhostels.jsp");
